...
function UpdateTransactionListUI(Transactions){
    ...
    element.innerHTML += '<div class="relative bg-white border-2 border-t-0 border-gray-200 rounded my-2 flex justify-between"><h4 class = "font-semibold text-center py-1 text-lg pl-3">'+last_entry.desc+'</h4><p class = "font-semibold pr-3 py-1 text-lg">$'+last_entry.Amount+'</p><span class="absolute w-1 h-full bg-'+last_entry.color+'-400 right-0"></span></div>'
